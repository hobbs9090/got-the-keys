...
RSpec.describe "Admin customers", type: :request do
  let(:admin) { FactoryBot.create(:admin, email: "customers-admin@gotthekeys.com", password: "changeme123", password_confirmation: "changeme123") }
  ...
  it "shows a customer search form on the index" do
    ...
    expect(search_form.at_css('[data-testid="admin-customers-search-clear"]')).to be_nil
