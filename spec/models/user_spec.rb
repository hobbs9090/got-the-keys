...
describe "A user" do
  ...
  it "requires last name" do
    ...
    expect(user.valid?).to be_false
    expect(user.errors[:last_name].any?).to be_true
  ...
  it "requires a mobile number" do
    ...
    expect(user.valid?).to be_false
    expect(user.errors[:mobile_number].any?).to be_true
  ...
  it "requires a language" do
    ...
    expect(user.valid?).to be_false
    expect(user.errors[:language].any?).to be_true
  ...
  it "requires language values of 'en' or 'zh'" do
    ...
    language.each do |language|
      ...
      expect(user.valid?).to be_true
      expect(user.errors[:language].any?).to be_false
    end
  end
