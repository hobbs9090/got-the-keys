module PropertiesHelper
  ...
  def property_fact_rows(property)
    [
      ...
      [t("ui.properties.facts.year_built"), property.year_built.present? ? property.year_built.to_s : nil],
      [t("ui.properties.facts.refurbished_year"), property.refurbished_year.present? ? property.refurbished_year.to_s : nil],
